...
$sql = "SELECT * FROM animaux 
        inner JOIN habitats ON animaux.id_habitat = habitats.id 
         ";
...
if (isset($_POST['fiche'])) {
    ...
    $animal = $stmtFiche->fetch(PDO::FETCH_ASSOC);
    print_r($animal);
}
echo count($data);
                    ...
                    <div class="flex justify-between items-start mb-3">
                        ...
                        <span class="text-gray-500 text-sm">
                            ...
                            switch($animal['alimentation']) {
                                case 'Carnivore': echo '🥩'; break;
                                case 'Herbivore': echo '🌿'; break;
                                case 'Omnivore': echo '🍎'; break;
                                default: echo '🍽️';
                            }
                            ?>
                        </span>
